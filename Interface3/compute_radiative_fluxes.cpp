								 ...
								 double	absorptance)
{
	...
	if (flux_transmitted < -0.00000001){
		printf("reflectance is %12.8f %12.8f %12.8f \n", reflectance, absorptance, opaque_transmittance);
		printf("flux_transmitted is %12.8f %12.8f %12.8f  %12.8f \n", flux_reflected, flux_absorbed, flux_transmitted, *flux_down_ptr);
		getchar();
