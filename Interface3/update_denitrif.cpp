...
//                                                              
//  DESCRIPTION                                                 
//	compute nitrification and denitrification based on soil temperature, moisture, heter. resp,	
					...
					double std)
{
	...
	if ((ns_soil->nitrate > ZERO)) {
		...
		nitrate_ratio = (ns_soil->nitrate) / (cs_soil->totalc + ns_soil->totaln) * 1e6;
		//-----------------------------------------------------------------------------------------------------------------------
		//	maximum denitrfication (kg/ha) based on available N03							
		//-----------------------------------------------------------------------------------------------------------------------
