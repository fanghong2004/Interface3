...
//
//  SYNOPSIS                                                    
//  void update_nitrif(struct  soil_c_object   *, struct  soil_n_object   *,   struct  cdayflux_patch_object *,    
//                      struct  ndayflux_patch_object *,struct	soil_class ,double	,double	,double )                               
//  OPTIONS                                                     
//                                                              
//                                                              
//  DESCRIPTION                                                 
//	compute nitrification and nitrification based on soil temperature, moisture, heter. resp,	
//	soil texture, and C substrate, N avaiilability	based on relationships derived in			
//	effect of PH currently and excess NH4 currently ignored					
//								
//	Parton et al. 1996. Generalized model of N2 and N20 production, Global Biogeochemical cycles, 10:3		
//	401-412							
//								
//  PROGRAMMER NOTES                                            
//===============================================================================================================================
				  ...
				  double std)
{
	...
	if ((ns_soil->sminn > ZERO)) {
		...
		//=======================================================================================================================
		// estimate bulk density from porosity and assuming a particle density of 2.65 g/cm3 (Dingman)					
		// and convert to kg/m3						
		// really should integrate depth to account for variable porosity but for now assume constant					
		...
		if (soil_type.sand > 0.5) {
			a = 0.55; b=1.70; c=-0.007; d=3.22;
		}
		else {
			a = 0.60; b=1.27; c=0.0012; d=2.84;
		}
		...
		///=======================================================================================================================
		//	estimate nitrification by scaling a maximum rate suggested by Parton et al.		
		//=======================================================================================================================
		...
		nitrify = 0.0;
	//=======================================================================================================================
	//	update state and flux variables	and convert from g to kg					
	//=======================================================================================================================
